...
//================================================================================================================================
  ...
  Widget searchbuilder(SearchModel? list, con, {isSearch = false}) => ConditionalBuilder(
    condition: list?.data?.products.isNotEmpty ?? false,
    builder: (context) => ListView.separated(
          physics: const BouncingScrollPhysics(),
          itemBuilder: (context, index) => buildSearchItem(list?.data!.products[index], con),
                    ...
                    children: [
                      ...
                      IconButton(
                        icon: CircleAvatar(
                          radius: 15.0,
                          backgroundColor:
                              HomeCubit.get(context).favorites[product.id]== true? defaultColor : Colors.grey,
                          child: const Icon(
